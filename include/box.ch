...
#define HB_B_DOUBLE_BOX_UNI    hb_UTF8ToStrBox( "▄▄▄█▀▀▀█▄▀██")
#define HB_B_SINGLE_BOX_UNI    hb_UTF8ToStrBox( "▄▄▄▌▀▀▀▌▄▀▌▌") 
